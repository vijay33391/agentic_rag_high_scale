...
class Settings:
    ...
    GROQ_SLUGx= "secondarymodel"  # openai/gpt-oss-120b
    GROQ_SLUG_2 = "brag"  # fallback: @brag/llama-3.3-70b-versatile
    ...
    # portkey_config
    portkey_config = os.getenv("postkey_config", "pc-portke-5dc95e")
